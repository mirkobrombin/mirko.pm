...
![Kodi estuary home](storage/kodi-server/Kodi/kodi_estuary_home.png)
...
![seleziona sorgente musicale](storage/kodi-server/Kodi/kodi_file_musica.png)
...
![kodi con tema unity](storage/kodi-server/Kodi/kodi_unity_home.png)
...
![add on snes](storage/kodi-server/Kodi/kodi_add_on_snes.png)
...
![impostazioni server](storage/kodi-server/Kodi/kodi_server_settings.png)
...
![interfaccia web kodi](storage/kodi-server/Kodi/kodi_web_interface.png)
...
![Kodi kore app](storage/kodi-server/Kodi/kodi_kore_app.jpg)
